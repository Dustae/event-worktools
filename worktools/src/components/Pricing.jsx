...
function Pricing() {
  ...
  return (
    <div>
      <div className="w3-container w3-center" style={{ padding: "128px 16px"}} id="pricing">
        <h3 className="w3-center" style={{ fontSize: "50px" }}>Pricing</h3>
        <p className="w3-large">Choose a pricing plan that fits your needs.</p>
        <div className="w3-row-padding" style={{ marginTop: "64px" }}>
          <div className="w3-third w3-section" data-aos="fade-up">
            <ul className="w3-ul w3-white w3-hover-shadow">
              ...
              <li className="w3-light-grey w3-padding-24">
                <button className="w3-button w3-green w3-hover-light-green w3-padding-large">Sign Up</button>
              </li>
            </ul>
          </div>
          <div className="w3-third" data-aos="fade-up">
            <ul className="w3-ul w3-white w3-hover-shadow">
