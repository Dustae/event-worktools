...
const DashBoard = () => {
  ...
  const fetchEventAnalytic = async () => {
    try {
      const response = await axios.get('/v1/api/org/event/analytic', { params: { org_id: 'abc123' } });
  ...
  const fetchEventDetail = async () => {
    try {
      const response = await axios.get('/v1/api/org/event/detail', { params: { org_id: 'abc123' } });
  ...
  const fetchDataTable = async () => {
    try {
      const response = await axios.get('/v1/api/org/event/table', { params: { org_id: 'abc123' } });
